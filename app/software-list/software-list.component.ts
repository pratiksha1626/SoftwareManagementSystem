...
searchByDeveloperName() {
  console.log('Name to search:', this.developer);
  
  this.softwareService.findByDeveloperName(this.developer).subscribe(
    details => {
      console.log('Response from service:', details);
      this.softwares = details;
    },
...
getUsersBySoftwareId(softwareId?: number){
    ...
    // this.userService.getUsersBySoftwareId(softwareId).subscribe( data => {
    //   console.log(data);
    //   this.getSoftwares();
    // }
    // )
